...
class ProductRichSnippetFactory extends AbstractRichSnippetFactory
{
    ...
    public function buildRichSnippet(RichSnippetSubjectInterface $subject): RichSnippetInterface
    {
        ...
        $richSnippet->addData([
            'offers' => $this->getAggregateOffer($subject),
        ]);
    ...
    private function getAggregateOffer(ProductInterface $subject): array
    {
    ...
    private function formatCurrencyForRichSnippets(int $amount, string $currency): string
    {
    ...
    private function getReviewAndRatingData(ProductInterface $subject): array
    {
